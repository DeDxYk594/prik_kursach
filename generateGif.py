...
def create_animated_png(X, Y, arr1, arr2, output_file='animation.png', duration=2000):
    """
    Создает анимированный PNG из координат точек и соединений между ними.
    ...
    # Создание APNG
    apng = APNG()
    frame_duration = duration / num_frames  # Продолжительность одного кадра
    for frame in frame_files:
        apng.append_file(frame, delay=int(frame_duration))
    ...
    print(f"Анимированный PNG сохранен как {output_file}.")
...
def create_animated_gif(X, Y, arr1, arr2, output_file='animation.gif', duration=2):
    ...
    imageio.mimsave(output_file, images, duration=duration / num_frames,)
